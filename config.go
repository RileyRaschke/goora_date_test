...
func init() {
	...
	viper.SetDefault(*dbConfKey+".Username", strings.ToUpper(os_user.Username))
	viper.SetDefault(*dbConfKey+".Password", "")
	viper.SetDefault(*dbConfKey+".PasswordCommand", "")
	viper.SetDefault(*dbConfKey+".Server", "localhost")
	viper.SetDefault(*dbConfKey+".Port", "1521")
	viper.SetDefault(*dbConfKey+".Service", "")
	viper.SetDefault(*dbConfKey+".SID", "")
	viper.SetDefault(*dbConfKey+".Options", make(map[string]string))
